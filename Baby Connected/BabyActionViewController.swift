//
//  BabyActionViewController.swift
//  Baby Connected
//
...
class BabyActionViewController: UITableViewController {
    
    let cellTitles: [String] = ["喝奶", "換尿布", "睡覺", "洗澡", "擠奶" ]
    
    enum BabyActions : Int {
        case breastfeed, diaper, sleep, bath, pump
    }
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        self.performSegueWithIdentifier("ADDACTION", sender: self.cellTitles[indexPath.row])
    ...
    func addAction(type:String)
    {
        ...
        action.setValue(NSDate(), forKey: "time")
        var error : NSError?
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let destinationVC = segue.destinationViewController as! AddActionViewController
        destinationVC.labelTitle =  sender as! String
